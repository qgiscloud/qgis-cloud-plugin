...
class Ui_map_settings(object):
    def setupUi(self, map_settings):
        ...
        self.user_list_lbl = QtWidgets.QLabel(self.groupBox)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.show_user_list_btn = QtWidgets.QPushButton(self.groupBox)
