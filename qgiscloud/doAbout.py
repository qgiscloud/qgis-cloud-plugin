...
#        
    ...
    def contribString(self):
        ...
        contribString.append( "<p>Pirmin Kalberer (project manager)<br>" )
        contribString.append( "Matthias Walker<br>" )
        contribString.append( "Dr. Marco Hugentobler<br>" )
        contribString.append( "Dr. Horst Düster<br><br>" )
